...
const Entertainment = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.ente_heading}>Entertainment</Text>
      {showListening ? (
      ...
      <View style={styles.menu_container}>
        <TouchableOpacity style={styles.button1} onPress={getJokes}>
          <View style={styles.container2}>
            <Text style={styles.myButton}>Jokes</Text>
            <View style={styles.menu_images_container1}>
              <Image style={styles.ask_images1} source={laughing} />
            </View>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button2} onPress={getNews}>
          <View style={styles.container3}>
            <Text style={styles.myButton}>News</Text>
            <View style={styles.menu_images_container2}>
              <Image style={styles.ask_images2} source={news} />
            </View>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button3} onPress={showHoroModal}>
          <View style={styles.container3}>
            <Text style={styles.myButton}>Hororscope</Text>
            <View style={styles.menu_images_container3}>
              <Image style={styles.ask_images3} source={tarot} />
            </View>
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button4} onPress={getFacts}>
          <View style={styles.container4}>
            <Text style={styles.myButton}>Cool {'\n'} Facts</Text>
            <View style={styles.menu_images_container4}>
              <Image style={styles.ask_images4} source={book} />
            </View>
          </View>
        </TouchableOpacity>
      </View>
