...
const Iphone13Mini = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 13 Mini 128 GB-----------//
  const filteredDataIphone13Mini128 = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 13 Mini 64 GB-----------//
  const filteredDataIphone13Mini64 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Mini' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Mini 256 GB-----------//
  const filteredDataIphone13Mini256 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Mini' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Mini 512 GB-----------//
  const filteredDataIphone13Mini512 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Mini' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Mini 1TB GB-----------//
  const filteredDataIphone13Mini1TB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Mini' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone13Mini128 = sumProperty(
    filteredDataIphone13Mini128,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13Mini64 = sumProperty(
    filteredDataIphone13Mini64,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13Mini256 = sumProperty(
    filteredDataIphone13Mini256,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13Mini512 = sumProperty(
    filteredDataIphone13Mini512,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13Mini1TB = sumProperty(
    filteredDataIphone13Mini1TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountFilteredDataIphone13Mini64}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13Mini128}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13Mini256}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13Mini1TB}`,
    },
    {
      id: 5,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13Mini512}`,
    },
  ];
  return (
