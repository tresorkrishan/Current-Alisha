...
const Iphone12 = ({navigation}) => {
  ...
  //Remaining Quantity for IPHONE 12 1TB GB-----------//
  const filteredDataIphone121TB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone121TB = sumProperty(
    filteredDataIphone121TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    ...
    },
    {
      ...
      Quantity: `${totalAmountFilteredDataIphone121TB}`,
    },
  ];
  return (
