...
const Iphone12Pro128GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 128GB GB-----------//
  const filteredDataIphone12Pro128GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12Pro128GBGreen = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12Pro128GBBlack = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12Pro128GBPurple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12Pro128GBWhite = sumProperty(
    filteredDataIphone12Pro128GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12Pro128GBGreen = sumProperty(
    filteredDataIphone12Pro128GBGreen,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12Pro128GBBlack = sumProperty(
    filteredDataIphone12Pro128GBBlack,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12Pro128GBPurple = sumProperty(
    filteredDataIphone12Pro128GBPurple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12Pro128GBWhite}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12Pro128GBGreen}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12Pro128GBBlack}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12Pro128GBPurple}`,
    },
  ];
  return (
...
export default Iphone12Pro128GB;
