...
const Iphone12Pro64GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 64GB GB-----------//
  const filteredDataIphone12Pro64GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12Pro64Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12Pro64Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12Pro64Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12Pro64White = sumProperty(
    filteredDataIphone12Pro64GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12Pro64Green = sumProperty(
    filteredDataIphone12Pro64Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12Pro64Black = sumProperty(
    filteredDataIphone12Pro64Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12Pro64Purple = sumProperty(
    filteredDataIphone12Pro64Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12Pro64White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12Pro64Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12Pro64Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12Pro64Purple}`,
    },
  ];
  return (
...
export default Iphone12Pro64GB;
