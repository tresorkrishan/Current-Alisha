...
const Iphone12256GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 256GB GB-----------//
  const filteredDataIphone12256GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12256Blue = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12256Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12256Red = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 12 128 GB Red-----------//
  const filteredDataIphone12256Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12256White = sumProperty(
    filteredDataIphone12256GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12256Blue = sumProperty(
    filteredDataIphone12256Blue,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12256Black = sumProperty(
    filteredDataIphone12256Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12256Red = sumProperty(
    filteredDataIphone12256Red,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12256Green = sumProperty(
    filteredDataIphone12256Green,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12256White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12256Blue}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12256Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12256Red}`,
    },
    {
      id: 5,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12256Green}`,
    },
  ];
  return (
