...
const Iphone12512GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 512GB GB-----------//
  const filteredDataIphone12512GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12512Blue = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12512Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12512Red = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 12 128 GB Red-----------//
  const filteredDataIphone12512Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12512White = sumProperty(
    filteredDataIphone12512GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12512Blue = sumProperty(
    filteredDataIphone12512Blue,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12512Black = sumProperty(
    filteredDataIphone12512Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12512Red = sumProperty(
    filteredDataIphone12512Red,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12512Green = sumProperty(
    filteredDataIphone12512Green,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12512White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12512Blue}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12512Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12512Red}`,
    },
    {
      id: 5,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12512Green}`,
    },
  ];
  return (
