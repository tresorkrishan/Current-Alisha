...
const Iphone1264GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 64GB GB-----------//
  const filteredDataIphone1264GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone1264Blue = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone1264Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone1264Red = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 12 128 GB Red-----------//
  const filteredDataIphone1264Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone1264White = sumProperty(
    filteredDataIphone1264GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone1264Blue = sumProperty(
    filteredDataIphone1264Blue,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone1264Black = sumProperty(
    filteredDataIphone1264Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone1264Red = sumProperty(
    filteredDataIphone1264Red,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone1264Green = sumProperty(
    filteredDataIphone1264Green,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone1264White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone1264Blue}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone1264Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone1264Red}`,
    },
    {
      id: 5,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone1264Green}`,
    },
  ];
  return (
