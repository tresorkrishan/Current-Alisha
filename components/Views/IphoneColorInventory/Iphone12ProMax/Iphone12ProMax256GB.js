...
const Iphone12ProMax256GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 256GB GB-----------//
  const filteredDataIphone12ProMax256GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12ProMax256Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax256Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax256Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12ProMax256White = sumProperty(
    filteredDataIphone12ProMax256GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax256Green = sumProperty(
    filteredDataIphone12ProMax256Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax256Black = sumProperty(
    filteredDataIphone12ProMax256Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax256Purple = sumProperty(
    filteredDataIphone12ProMax256Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax256White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax256Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax256Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12ProMax256Purple}`,
    },
  ];
  return (
...
export default Iphone12ProMax256GB;
