...
const Iphone12ProMax512GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 512GB GB-----------//
  const filteredDataIphone12ProMax512GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12ProMax512Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax512Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax512Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12ProMax512White = sumProperty(
    filteredDataIphone12ProMax512GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax512Green = sumProperty(
    filteredDataIphone12ProMax512Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax512Black = sumProperty(
    filteredDataIphone12ProMax512Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax512Purple = sumProperty(
    filteredDataIphone12ProMax512Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax512White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax512Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax512Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12ProMax512Purple}`,
    },
  ];
  return (
...
export default Iphone12ProMax512GB;
