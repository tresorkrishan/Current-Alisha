...
const Iphone12ProMax64GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 64GB GB-----------//
  const filteredDataIphone12ProMax64GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12ProMax64Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax64Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax64Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12ProMax64White = sumProperty(
    filteredDataIphone12ProMax64GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax64Green = sumProperty(
    filteredDataIphone12ProMax64Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax64Black = sumProperty(
    filteredDataIphone12ProMax64Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax64Purple = sumProperty(
    filteredDataIphone12ProMax64Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax64White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax64Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax64Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12ProMax64Purple}`,
    },
  ];
  return (
...
export default Iphone12ProMax64GB;
