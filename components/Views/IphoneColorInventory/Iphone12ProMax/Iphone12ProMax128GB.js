...
const Iphone12ProMax128GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 128GB GB-----------//
  const filteredDataIphone12ProMax128GBWhite = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone12ProMax128Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax128Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone12ProMax128Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone12ProMax128White = sumProperty(
    filteredDataIphone12ProMax128GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax128Green = sumProperty(
    filteredDataIphone12ProMax128Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax128Black = sumProperty(
    filteredDataIphone12ProMax128Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone12ProMax128Purple = sumProperty(
    filteredDataIphone12ProMax128Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax128White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax128Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone12ProMax128Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone12ProMax128Purple}`,
    },
  ];
  return (
...
export default Iphone12ProMax128GB;
