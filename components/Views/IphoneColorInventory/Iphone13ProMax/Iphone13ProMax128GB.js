...
const Iphone13ProMax128GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 13  Pro Max 128GB GB-----------//
  const filteredDataIphone13ProMax128GBWhite = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 128 GB Green-----------//
  const filteredDataIphone13ProMax128GBGreen = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 128 GB Black-----------//
  const filteredDataIphone13ProMax128GBBlack = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 128 GB Purple-----------//
  const filteredDataIphone13ProMax128GBPurple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone13ProMax128GBWhite = sumProperty(
    filteredDataIphone13ProMax128GBWhite,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax128GBGreen = sumProperty(
    filteredDataIphone13ProMax128GBGreen,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax128GBBlack = sumProperty(
    filteredDataIphone13ProMax128GBBlack,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax128GBPurple = sumProperty(
    filteredDataIphone13ProMax128GBPurple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax128GBWhite}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax128GBGreen}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax128GBBlack}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13ProMax128GBPurple}`,
    },
  ];
  return (
...
export default Iphone13ProMax128GB;
