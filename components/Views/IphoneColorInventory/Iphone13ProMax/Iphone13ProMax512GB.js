...
const Iphone13ProMax512GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 13  Pro Max 512GB GB-----------//
  const filteredDataIphone13ProMax512GBWhite = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 512 GB Green-----------//
  const filteredDataIphone13ProMax512GBGreen = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 512 GB Black-----------//
  const filteredDataIphone13ProMax512GBBlack = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 512 GB Purple-----------//
  const filteredDataIphone13ProMax512GBPurple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone13ProMax512GBWhite = sumProperty(
    filteredDataIphone13ProMax512GBWhite,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax512GBGreen = sumProperty(
    filteredDataIphone13ProMax512GBGreen,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax512GBBlack = sumProperty(
    filteredDataIphone13ProMax512GBBlack,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax512GBPurple = sumProperty(
    filteredDataIphone13ProMax512GBPurple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax512GBWhite}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax512GBGreen}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax512GBBlack}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13ProMax512GBPurple}`,
    },
  ];
  return (
...
export default Iphone13ProMax512GB;
