...
const Iphone13ProMax256GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 13  Pro Max 256GB GB-----------//
  const filteredDataIphone13ProMax256GBWhite = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 256 GB Green-----------//
  const filteredDataIphone13ProMax256GBGreen = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 256 GB Black-----------//
  const filteredDataIphone13ProMax256GBBlack = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 256 GB Purple-----------//
  const filteredDataIphone13ProMax256GBPurple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone13ProMax256GBWhite = sumProperty(
    filteredDataIphone13ProMax256GBWhite,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax256GBGreen = sumProperty(
    filteredDataIphone13ProMax256GBGreen,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax256GBBlack = sumProperty(
    filteredDataIphone13ProMax256GBBlack,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone13ProMax256GBPurple = sumProperty(
    filteredDataIphone13ProMax256GBPurple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax256GBWhite}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax256GBGreen}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataIphone13ProMax256GBBlack}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13ProMax256GBPurple}`,
    },
  ];
  return (
...
export default Iphone13ProMax256GB;
