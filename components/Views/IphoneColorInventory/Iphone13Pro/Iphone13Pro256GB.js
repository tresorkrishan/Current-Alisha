...
const Iphone13Pro256GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 256GB GB-----------//
  const filteredDataIphone13Pro256GBWhite = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 12 256 GB Gold-----------//
  const filteredDataIphone13Pro256GBGold = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone13Pro256GBGraphite = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 12 256 GB SierraBlue-----------//
  const filteredDataIphone13Pro256GBSierraBlue = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone13Pro256White = sumProperty(
    filteredDataIphone13Pro256GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone13Pro256Gold = sumProperty(
    filteredDataIphone13Pro256GBGold,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone13Pro256Graphite = sumProperty(
    filteredDataIphone13Pro256GBGraphite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone13Pro256SierraBlue = sumProperty(
    filteredDataIphone13Pro256GBSierraBlue,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone13Pro256White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone13Pro256Gold}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      title: '256 GB Graphite',
      image: 'https://images.financialexpress.com/2021/09/iphone-13-main.png',
      Quantity: `${totalAmountfilteredDataIphone13Pro256Graphite}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      title: '256 GB Sierra Blue',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone13Pro256SierraBlue}`,
    },
  ];
  return (
...
export default Iphone13Pro256GB;
