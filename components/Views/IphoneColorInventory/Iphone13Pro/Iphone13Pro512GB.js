...
const Iphone13Pro512GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 512GB GB-----------//
  const filteredDataIphone13Pro512GBWhite = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 12 512 GB Gold-----------//
  const filteredDataIphone13Pro512GBGold = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone13Pro512GBGraphite = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone13Pro512GBSierraBlue = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone13Pro512White = sumProperty(
    filteredDataIphone13Pro512GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone13Pro512Gold = sumProperty(
    filteredDataIphone13Pro512GBGold,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone13Pro512Graphite = sumProperty(
    filteredDataIphone13Pro512GBGraphite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone13Pro512SierraBlue = sumProperty(
    filteredDataIphone13Pro512GBSierraBlue,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone13Pro512White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone13Pro512Gold}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      title: '512 GB Graphite',
      image: 'https://images.financialexpress.com/2021/09/iphone-13-main.png',
      Quantity: `${totalAmountfilteredDataIphone13Pro512Graphite}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      title: '512 GB Sierra Blue',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone13Pro512SierraBlue}`,
    },
  ];
  return (
...
export default Iphone13Pro512GB;
