...
const Iphone11128 = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 11 128 GB-----------//
  const filteredDataIphone11128White = productData
    .filter((item) => {
      return (
  ...
  const filteredDataIphone11128Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone11128Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone11128Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone11128White = sumProperty(
    filteredDataIphone11128White,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone11128Green = sumProperty(
    filteredDataIphone11128Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone11128Black = sumProperty(
    filteredDataIphone11128Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone11128Purple = sumProperty(
    filteredDataIphone11128Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone11128White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone11128Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone11128Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone11128Purple}`,
    },
  ];
  return (
