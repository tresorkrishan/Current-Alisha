...
const Iphone1164GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 11 64GB GB-----------//
  const filteredDataIphone1164GBWhite = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 11 128 GB Green-----------//
  const filteredDataIphone1164Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 11 128 GB Black-----------//
  const filteredDataIphone1164Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 11 128 GB Purple-----------//
  const filteredDataIphone1164Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone1164White = sumProperty(
    filteredDataIphone1164GBWhite,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone1164Green = sumProperty(
    filteredDataIphone1164Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone1164Black = sumProperty(
    filteredDataIphone1164Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone1164Purple = sumProperty(
    filteredDataIphone1164Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone1164White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone1164Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone1164Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone1164Purple}`,
    },
  ];
  return (
