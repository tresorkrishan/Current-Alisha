...
const Iphone11256GB = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 11 256 GB-----------//
  const filteredDataIphone11256White = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 11 256 GB Green-----------//
  const filteredDataIphone11256Green = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 11 256 GB Black-----------//
  const filteredDataIphone11256Black = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 11 256 GB Purple-----------//
  const filteredDataIphone11256Purple = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 11' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountfilteredDataIphone11256White = sumProperty(
    filteredDataIphone11256White,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone11256Green = sumProperty(
    filteredDataIphone11256Green,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone11256Black = sumProperty(
    filteredDataIphone11256Black,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone11256Purple = sumProperty(
    filteredDataIphone11256Purple,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIphone11256White}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone11256Green}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIphone11256Black}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone11256Purple}`,
    },
  ];
  return (
