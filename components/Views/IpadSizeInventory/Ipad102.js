...
const Ipad102 = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPad  10.2 128 GB-----------//
  const filteredDataIpad102128 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 10.2' &&
  ...
  //Remaining Quantity for IPad 10.2 64 GB-----------//
  const filteredDataIpad10264 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 10.2' &&
        item.Item_Category_Code === 'A20' &&
  ...
  //Remaining Quantity for IPad  10.2 256 GB-----------//
  const filteredDataIpad102256 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 10.2' &&
        item.Item_Category_Code === 'A20' &&
  ...
  const filteredDataIpad102512 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 10.2' &&
        item.Item_Category_Code === 'A20' &&
  ...
  //Remaining Quantity for IPad  10.2 1TB GB-----------//
  const filteredDataIpad1021TB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 10.2' &&
        item.Item_Category_Code === 'A20' &&
  ...
  let totalAmountfilteredDataIpad10264 = sumProperty(
    filteredDataIpad10264,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad102128 = sumProperty(
    filteredDataIpad102128,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad102256 = sumProperty(
    filteredDataIpad102256,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad102512 = sumProperty(
    filteredDataIpad102512,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad1021TB = sumProperty(
    filteredDataIpad1021TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIpad10264}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad102128}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad102256}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIpad102512}`,
    },
    {
      id: 5,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad1021TB}`,
    },
  ];
  return (
