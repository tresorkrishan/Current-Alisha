...
const Ipad11 = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPad  11.0 128 GB-----------//
  const filteredDataIpad11128 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 11.0' &&
  ...
  //Remaining Quantity for IPad 11.0 64 GB-----------//
  const filteredDataIpad1164 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 11.0' &&
        item.Item_Category_Code === 'A20' &&
  ...
  //Remaining Quantity for IPad  11.0 256 GB-----------//
  const filteredDataIpad11256 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 11.0' &&
        item.Item_Category_Code === 'A20' &&
  ...
  //Remaining Quantity for IPad  11 512 GB-----------//
  const filteredDataIpad11512 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 11.0' &&
        item.Item_Category_Code === 'A20' &&
  ...
  //Remaining Quantity for IPad  11 1TB GB-----------//
  const filteredDataIpad111TB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 11.0' &&
        item.Item_Category_Code === 'A20' &&
  ...
  let totalAmountfilteredDataIpad1164 = sumProperty(
    filteredDataIpad1164,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad11128 = sumProperty(
    filteredDataIpad11128,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad11256 = sumProperty(
    filteredDataIpad11256,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad11512 = sumProperty(
    filteredDataIpad11512,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad111TB = sumProperty(
    filteredDataIpad111TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIpad1164}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad11128}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad11256}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIpad11512}`,
    },
    {
      id: 5,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad111TB}`,
    },
  ];
  return (
