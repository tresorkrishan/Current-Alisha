...
const Ipad12 = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPad  12.9 128 GB-----------//
  const filteredDataIpad12128 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 12.9' &&
  ...
  //Remaining Quantity for IPad 12.9 64 GB-----------//
  const filteredDataIpad1264 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 12.9' &&
        item.Item_Category_Code === 'A20' &&
  ...
  //Remaining Quantity for IPad  12.9 256 GB-----------//
  const filteredDataIpad12256 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 12.9' &&
        item.Item_Category_Code === 'A20' &&
  ...
  const filteredDataIpad12512 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 12.9' &&
        item.Item_Category_Code === 'A20' &&
  ...
  //Remaining Quantity for IPad  12.9 1TB GB-----------//
  const filteredDataIpad121TB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPad 12.9' &&
        item.Item_Category_Code === 'A20' &&
  ...
  let totalAmountfilteredDataIpad1264 = sumProperty(
    filteredDataIpad1264,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad12128 = sumProperty(
    filteredDataIpad12128,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad12256 = sumProperty(
    filteredDataIpad12256,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad12512 = sumProperty(
    filteredDataIpad12512,
    'Remaining_Qty',
  );

  let totalAmountfilteredDataIpad121TB = sumProperty(
    filteredDataIpad121TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountfilteredDataIpad1264}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad12128}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad12256}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIpad12512}`,
    },
    {
      id: 5,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountfilteredDataIpad121TB}`,
    },
  ];
  return (
