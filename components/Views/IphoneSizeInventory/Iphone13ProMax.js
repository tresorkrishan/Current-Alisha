...
const Iphone13ProMax = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 13 Pro Max 128 GB-----------//
  const filteredDataIphone13ProMax128 = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 13 Pro Max 64 GB-----------//
  const filteredDataIphone13ProMax64 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone13ProMax256 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone13ProMax512 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  const filteredDataIphone13ProMax1TB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro max' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone13ProMax128 = sumProperty(
    filteredDataIphone13ProMax128,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13ProMax64 = sumProperty(
    filteredDataIphone13ProMax64,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13ProMax256 = sumProperty(
    filteredDataIphone13ProMax256,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13ProMax512 = sumProperty(
    filteredDataIphone13ProMax512,
    'Remaining_Qty',
  );
  let totalAmountfilteredDataIphone13ProMax1TB = sumProperty(
    filteredDataIphone13ProMax1TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      id: 1,
      view: 'Iphone13ProMax128GB',
      title: '128 GB',
      image:
        'https://fdn2.gsmarena.com/vv/pics/apple/apple-iphone-13-pro-max-2.jpg',
      Quantity: `${totalAmountFilteredDataIphone13ProMax128}`,
    },
    {
      id: 2,
      view: 'Iphone13ProMax64GB',
      title: '64 GB',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13ProMax64}`,
    },
    {
      id: 3,
      view: 'Iphone13ProMax256GB',
      title: '256 GB',
      image: 'https://images.financialexpress.com/2021/09/iphone-13-main.png',
      Quantity: `${totalAmountFilteredDataIphone13ProMax256}`,
    },
    {
      id: 4,
      view: 'Iphone13ProMax512GB',
      title: '512 GB',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13ProMax512}`,
    },
    {
      id: 5,
      view: 'Iphone13ProMax1TBGB',
      title: '1TB GB',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountfilteredDataIphone13ProMax1TB}`,
    },
  ];
  return (
