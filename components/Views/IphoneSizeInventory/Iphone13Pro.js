...
const Iphone13Pro = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 13 Pro 128 GB-----------//
  const filteredDataIphone13Pro128GB = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 13 Pro 64 GB-----------//
  const filteredDataIphone13Pro64GB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro 256 GB-----------//
  const filteredDataIphone13Pro256GB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 13 Pro 512 GB-----------//
  const filteredDataIphone13Pro512GB = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 13 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone13Pro128GB = sumProperty(
    filteredDataIphone13Pro128GB,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13Pro64GB = sumProperty(
    filteredDataIphone13Pro64GB,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13Pro256GB = sumProperty(
    filteredDataIphone13Pro256GB,
    'Remaining_Qty',
  );

  let totalAmountFilteredDataIphone13Pro512GB = sumProperty(
    filteredDataIphone13Pro512GB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      id: 1,
      view: 'Iphone13Pro64GB',
      title: '64 GB',
      image:
        'https://fdn2.gsmarena.com/vv/pics/apple/apple-iphone-13-pro-max-2.jpg',
      Quantity: `${totalAmountFilteredDataIphone13Pro64GB}`,
    },
    {
      id: 2,
      view: 'Iphone13Pro128GB',
      title: '128 GB',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13Pro128GB}`,
    },
    {
      id: 3,
      view: 'Iphone13Pro256GB',
      title: '256 GB',
      image: 'https://images.financialexpress.com/2021/09/iphone-13-main.png',
      Quantity: `${totalAmountFilteredDataIphone13Pro256GB}`,
    },
    {
      id: 4,
      view: 'Iphone13Pro512GB',
      title: '512 GB',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone13Pro512GB}`,
    },
  ];
  return (
