...
const Iphone12Pro = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for IPHONE 12 Pro  128 GB-----------//
  const filteredDataIphone12Pro128 = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for IPHONE 12 Pro  64 GB-----------//
  const filteredDataIphone12Pro64 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 12 Pro 256 GB-----------//
  const filteredDataIphone12Pro256 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  //Remaining Quantity for IPHONE 12 Pro 512 GB-----------//
  const filteredDataIphone12Pro512 = productData
    .filter((item) => {
      return (
        item.Category_4 === 'iPhone 12 Pro' &&
        item.Item_Category_Code === 'A15' &&
  ...
  let totalAmountFilteredDataIphone12Pro128 = sumProperty(
    filteredDataIphone12Pro128,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone12Pro64 = sumProperty(
    filteredDataIphone12Pro64,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone12Pro256 = sumProperty(
    filteredDataIphone12Pro256,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataIphone12Pro512 = sumProperty(
    filteredDataIphone12Pro512,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      id: 1,
      view: 'Iphone12Pro128GB',
      title: '128 GB',
      image:
        'https://fdn2.gsmarena.com/vv/pics/apple/apple-iphone-13-pro-max-2.jpg',
      Quantity: `${totalAmountFilteredDataIphone12Pro128}`,
    },
    {
      id: 2,
      view: 'Iphone12Pro64GB',
      title: '64 GB',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone12Pro64}`,
    },
    {
      id: 3,
      view: 'Iphone12Pro256GB',
      title: '256 GB',
      image: 'https://images.financialexpress.com/2021/09/iphone-13-main.png',
      Quantity: `${totalAmountFilteredDataIphone12Pro256}`,
    },
    {
      id: 4,
      view: 'Iphone12Pro512GB',
      title: '512 GB',
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataIphone12Pro512}`,
    },
  ];
  return (
