...
const MacMiniM1 = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for MacMiniM1  128 GB-----------//
  const filteredDataMacMiniM1128 = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for MacMiniM1 256 GB-----------//
  const filteredDataMacMiniM1256 = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  //Remaining Quantity for MacMiniM1 512 GB-----------//
  const filteredDataMacMiniM1512 = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  //Remaining Quantity for MacMiniM1 1TB GB-----------//
  const filteredDataMacMiniM11TB = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  let totalAmountFilteredDataMacMiniM1128 = sumProperty(
    filteredDataMacMiniM1128,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacMiniM1256 = sumProperty(
    filteredDataMacMiniM1256,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacMiniM1512 = sumProperty(
    filteredDataMacMiniM1512,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacMiniM11TB = sumProperty(
    filteredDataMacMiniM11TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountFilteredDataMacMiniM1128}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataMacMiniM1256}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataMacMiniM1512}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataMacMiniM11TB}`,
    },
  ];
  return (
