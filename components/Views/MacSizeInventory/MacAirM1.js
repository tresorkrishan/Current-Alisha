...
const MacBookAirM1 = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for MacBookAirM1  128 GB-----------//
  const filteredDataMacBookAirM1128 = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for MacBookAirM1 256 GB-----------//
  const filteredDataMacBookAirM1256 = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  //Remaining Quantity for MacBookAirM1 512 GB-----------//
  const filteredDataMacBookAirM1512 = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  //Remaining Quantity for MacBookAirM1 1TB GB-----------//
  const filteredDataMacBookAirM11TB = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  let totalAmountFilteredDataMacBookAirM1128 = sumProperty(
    filteredDataMacBookAirM1128,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacBookAirM1256 = sumProperty(
    filteredDataMacBookAirM1256,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacBookAirM1512 = sumProperty(
    filteredDataMacBookAirM1512,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacBookAirM11TB = sumProperty(
    filteredDataMacBookAirM11TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountFilteredDataMacBookAirM1128}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataMacBookAirM1256}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataMacBookAirM1512}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataMacBookAirM11TB}`,
    },
  ];
  return (
