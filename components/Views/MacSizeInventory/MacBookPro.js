...
const MacBookPro = ({navigation}) => {
  let productData = ErpMenu();

  //Remaining Quantity for MacBookPro  128 GB-----------//
  const filteredDataMacBookPro128 = productData
    .filter((item) => {
      return (
  ...
  //Remaining Quantity for MacBookPro 256 GB-----------//
  const filteredDataMacBookPro256 = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  //Remaining Quantity for MacBookPro 512 GB-----------//
  const filteredDataMacBookPro512 = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  //Remaining Quantity for MacBookPro 1TB GB-----------//
  const filteredDataMacBookPro1TB = productData
    .filter((item) => {
      return (
        (item.Item_Category_Code === 'A12' ||
          item.Item_Category_Code === 'A13' ||
  ...
  let totalAmountFilteredDataMacBookPro128 = sumProperty(
    filteredDataMacBookPro128,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacBookPro256 = sumProperty(
    filteredDataMacBookPro256,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacBookPro512 = sumProperty(
    filteredDataMacBookPro512,
    'Remaining_Qty',
  );
  let totalAmountFilteredDataMacBookPro1TB = sumProperty(
    filteredDataMacBookPro1TB,
    'Remaining_Qty',
  );
  ...
  let data = [
    {
      ...
      Quantity: `${totalAmountFilteredDataMacBookPro128}`,
    },
    {
      id: 2,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataMacBookPro256}`,
    },
    {
      id: 3,
      view: 'ProductListing',
      ...
      Quantity: `${totalAmountFilteredDataMacBookPro512}`,
    },
    {
      id: 4,
      view: 'ProductListing',
      ...
      image:
        'https://9to5mac.com/wp-content/uploads/sites/6/2016/03/iphone-se.png',
      Quantity: `${totalAmountFilteredDataMacBookPro1TB}`,
    },
  ];
  return (
